...
export const SDKButton = ({
  ...
  return (
    <motion.button
      className={`flex h-9 items-center justify-center rounded-md bg-gradient-to-r ${gradients[color]} px-4 text-xs font-medium text-white shadow-sm transition-all cursor-pointer ${className}`}
