    ...
    <div className="container mx-auto max-w-6xl">
      ...
      >
        ...
        <p className="text-muted-foreground mx-auto max-w-2xl text-xl">
          Simplify and accelerate your integration workflow with
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        ...
        >
          ...
          <div className="bg-primary/10 text-primary relative z-10 mb-4 flex h-12 w-12 items-center justify-center rounded-lg">
            <svg
          ...
          <p className="text-muted-foreground relative z-10">
            Connect your GitHub repositories and let AI analyze your
            codebase to implement SDK integrations automatically.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          whileHover={{ y: -5, transition: { duration: 0.2 } }}
        >
          <div className="bg-chart-3/5 absolute top-0 right-0 h-32 w-32 translate-x-1/4 -translate-y-1/4 transform rounded-full blur-3xl" />
          <div className="bg-primary/10 text-primary relative z-10 mb-4 flex h-12 w-12 items-center justify-center rounded-lg">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
          ...
          <p className="text-muted-foreground relative z-10">
            Integrate popular SDKs like Stripe, PostHog, Auth0, and Sentry
      ...
      <div className="mt-20 grid grid-cols-1 gap-12 md:grid-cols-2">
        ...
        >
          <h3 className="mb-6 text-2xl font-bold">Supported Platforms</h3>
        ...
        >
          <h3 className="mb-6 text-2xl font-bold">Supported SDKs</h3>
