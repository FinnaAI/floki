...
export function AppAnimation({ className }: { className?: string }) {
  return (
    <motion.div
      className={`relative hidden md:flex md:flex-1 h-[450px] ${className}`}
    ...
    >
      ...
      <motion.div
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 bg-card rounded-full w-28 h-28 flex items-center justify-center shadow-xl border-4 border-primary/30"
        initial={{ scale: 0.8, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        transition={{ delay: 0.5, duration: 0.5 }}
      >
        <div className="text-center">
          <div className="text-chart-1 font-bold text-xl">Floki</div>
      ...
      >
        <div className="bg-card shadow-lg rounded-lg border p-4 w-52">
          <div className="mb-2 flex items-center gap-2">
            <div className="bg-blue-500/20 text-blue-500 p-2 rounded-md">
              <svg
      ...
      {/* Prompt Templates */}
      <motion.div
        className="absolute left-[65%] top-[20%] z-10"
        initial={{ y: -20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
      ...
      >
        <div className="bg-card shadow-lg rounded-lg border p-4 w-52">
          <div className="mb-2 flex items-center gap-2">
            <div className="bg-purple-500/20 text-purple-500 p-2 rounded-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
      ...
      >
        <div className="bg-card shadow-lg rounded-lg border p-4 w-52">
          <div className="mb-2 flex items-center gap-2">
            <div className="bg-emerald-500/20 text-emerald-500 p-2 rounded-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
      ...
      {/* IDE Integration */}
      <motion.div
        className="absolute left-[55%] bottom-[5%] z-10"
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
      ...
      >
        <div className="bg-card shadow-lg rounded-lg border p-4 w-52">
          <div className="mb-2 flex items-center gap-2">
            <div className="bg-amber-500/20 text-amber-500 p-2 rounded-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
      ...
      <motion.div
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-52 h-52 rounded-full border border-dashed border-primary/20"
        initial={{ scale: 0.8, opacity: 0 }}
      ...
      <motion.div
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full border border-dashed border-primary/10"
        initial={{ scale: 0.8, opacity: 0 }}
        animate={{ scale: 1, opacity: 0.7 }}
        transition={{ delay: 0.7, duration: 0.5 }}
      />
      ...
      <motion.div
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full border border-dashed border-primary/5"
        initial={{ scale: 0.8, opacity: 0 }}
        animate={{ scale: 1, opacity: 0.7 }}
