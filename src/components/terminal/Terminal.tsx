...
export function Terminal() {
	...
	return (
		<div className="flex h-full w-full flex-col overflow-hidden">
			<div className="relative flex h-full w-full flex-col overflow-hidden rounded-xl border border-slate-200 bg-gradient-to-b from-slate-50 to-white shadow-lg dark:border-slate-800 dark:from-slate-950 dark:to-slate-900">
				{/* Header - fixed to top */}
				<div className="sticky top-0 z-10 flex items-center justify-between rounded-t-xl border-slate-200 border-b bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
					...
					<div className="flex items-center space-x-2">
						<div className="mr-2 flex items-center space-x-2">
							...
							<Switch
								...
								id="codex-mode"
							/>
							<label htmlFor="codex-mode" className="font-medium text-sm">
								Codex
							</label>
						</div>
						<Button
