  ...
  return (
    <div className="h-screen w-full overflow-hidden">
      ...
      <div className="flex flex-col h-full overflow-hidden dark:bg-slate-900">
        ...
        <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-800 flex flex-row justify-between">
          <div className="flex flex-row gap-2 justify-between w-full p-2">
            <div className="flex items-center gap-2">
              ...
              <div className="relative flex-1 ml-2">
                <Input
                  ...
                  className="h-8 w-full pl-8 pr-4 rounded-md bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600"
                />
              </div>
            </div>
            ...
            <div className="flex space-x-3">
              ...
              <Button
                ...
                size="sm"
                asChild
                className="rounded-lg border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 shadow-sm"
              >
                <Link href="/">
                  <Home
                    size={16}
        ...
        <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-800 flex flex-row justify-between">
          {/* Breadcrumbs */}
          <Breadcrumb className="flex items-center text-sm overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden py-1 max-w-full">
            ...
            <ScrollArea className="h-full">
              <div className="p-2">
                {loading && !filteredFiles.length ? (
                  ...
                  <div className="flex flex-col justify-center items-center h-24 text-slate-500">
                    {searchQuery ? (
                      <>
                  ...
                  <div
                    key={currentPath}
                    className="space-y-0.5 animate-[fadeIn_2s_ease-out]"
                  >
                    {filteredFiles.map((file, index) => {
                      ...
                      return (
                        <div
                          key={file.path}
                          className={cn(
                            "relative flex items-center gap-2 py-1.5 px-3 rounded-md cursor-pointer transition-all",
        ...
        {/* Footer/status bar */}
        <div className="h-8 bg-slate-100 dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 px-4 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
          <div>
